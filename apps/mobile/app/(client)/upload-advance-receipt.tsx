...
export default function UploadAdvanceReceiptScreen() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    try {
      await ordersAPI.submitAdvancePayment(orderId, imageUri)
      Alert.alert(
        '✅ Comprobante enviado',
        'Tu comprobante fue enviado. El equipo de RepTel lo revisará y confirmará tu pago pronto. El técnico será despachado una vez confirmado.',
        [
          {
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Toma o selecciona la foto de tu comprobante de pago anticipado
          </Text>
        </View>
        ...
        >
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoText}>
              📎 Sube el screenshot o foto del comprobante de tu transferencia, Pago Móvil o Binance. El equipo de RepTel lo revisará y confirmará el pago manualmente para despachar al técnico.
            </Text>
          </View>
