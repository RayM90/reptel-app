...
export default function FinalPaymentScreen() {
  ...
  const handleSubmit = async () => {
    if (!isFormValid()) {
      Alert.alert('Datos incompletos', 'Selecciona un método de pago y completa todos los campos requeridos.')
      return
    }
    if (!orderId) {
        ...
        >
          ...
          {selectedMethod && (
            <View style={styles.form}>
              ...
              <Field label="Monto enviado ($)" value={monto} onChangeText={setMonto} placeholder="Ej. 35.00" keyboardType="decimal-pad" />
