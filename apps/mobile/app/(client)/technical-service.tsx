          ...
          <View style={styles.section}>
                      ...
                      >
                        <View style={styles.faultItemContent}>
                          ...
                          <View style={{ flex: 1 }}>
                            ...
                            {item.requiresShop && (
                              <Text style={styles.requiresShop}>Requiere evaluación en taller</Text>
                            )}
                          </View>
            ...
            {!showCustom ? (
              <TouchableOpacity style={styles.customBtn} onPress={() => setShowCustom(true)}>
                <Text style={styles.customBtnText}>La falla no está en la lista</Text>
              </TouchableOpacity>
            ) : (
...
const styles = StyleSheet.create({
  ...
  typeBtnActive: { borderColor: '#5564ad', backgroundColor: '#eef2ff' },
  typeBtnText: { fontSize: 15, color: '#666', fontWeight: '600' },
  typeBtnTextActive: { color: '#17247a' },
  ...
  checkboxActive: { backgroundColor: '#5564ad', borderColor: '#5564ad' },
  ...
  categoryTitle: { fontSize: 15, fontWeight: '600', color: '#17247a' },
  categoryArrow: { color: '#5564ad', fontSize: 13 },
  ...
  faultItemSelected: { backgroundColor: '#eef2ff' },
  ...
  faultItemPrice: { fontSize: 15, fontWeight: '700', color: '#5564ad', marginLeft: 8, minWidth: 55, textAlign: 'right' },
  customBtn: {
    borderWidth: 2, borderColor: '#5564ad', borderStyle: 'dashed',
    borderRadius: 8, padding: 14, alignItems: 'center', marginTop: 8,
  },
  customBtnText: { color: '#5564ad', fontSize: 15, fontWeight: '600' },
  customForm: {
  ...
  btnAdd: {
    flex: 1, backgroundColor: '#5564ad', borderRadius: 8,
  ...
  summaryCustomTag: { fontSize: 11, color: '#5564ad', marginTop: 2 },
  summaryPrice: { fontSize: 15, fontWeight: '700', color: '#5564ad', marginRight: 8 },
  removeBtn: { padding: 4 },
  ...
  totalLabel: { fontSize: 15, fontWeight: '700', color: '#17247a' },
  totalValue: { fontSize: 24, fontWeight: 'bold', color: '#17247a' },
